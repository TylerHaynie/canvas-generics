import { UI_EVENT_TYPE, MOUSE_STATE } from '../../engine/events/canvas-enums';
...
export class ElementBase implements IDrawable  {
    ...
    private canvasEvent = new CanvasEvent<MouseEventData>();
    on(on: UI_EVENT_TYPE, callback: (e: MouseEventData) => void) {
    ...
    private fireEvent(e: MouseEventData) {
    ...
    elementMouseDown(e: MouseEventData) {
    ...
    elementMouseUp(e: MouseEventData) {
    ...
    elementMouseHover(e: MouseEventData) {
        if (this.previousEventType !== UI_EVENT_TYPE.DOWN) {
    ...
    elementMouseMove(e: MouseEventData) {
    ...
    elementMouseOut(e: MouseEventData) {
    ...
    private startDrag(e: MouseEventData) {
    ...
    private dragElement(e: MouseEventData) {
        e.uiMouseState = MOUSE_STATE.GRAB;
