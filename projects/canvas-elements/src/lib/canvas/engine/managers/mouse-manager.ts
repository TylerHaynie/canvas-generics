...
import { MouseEventData } from '../events/event-data';
...
export class MouseManager {
    ...
    private _mouseEvents = new CanvasEvent<MouseEventData>();
    on(on: MOUSE_EVENT_TYPE, callback: (e: MouseEventData) => void) {
    ...
    private setMousePosition(x: number, y: number): void {
        this._mousePosition ? this._mousePosition.setValues(x, y, 0) : this._mousePosition = new Vector(x, y, 0);
    }
}
