...
import { RandomUtility } from '../../../engine/utilities/random-utility';
...
export class ParticleBase implements IDrawable {
    ...
    wiggle() {
        let nx = this.shape.position.x + RandomUtility.randomWithNegative();
        let ny = this.shape.position.y + RandomUtility.randomWithNegative();
